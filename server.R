...
shinyServer(function(input, output, session) {
  ...
  setup_twitter_oauth(consumer_key = "a5Zo2dQQsGFlkqooxbnJkYvGS", consumer_secret = "LuAtcckSOjzyanjAiujKF8asZuAvPydscSdzJeMpnUANOgB9Z2")
  ...
  observe({
    ...
    tweets_result = searchTwitter("MWC16")
